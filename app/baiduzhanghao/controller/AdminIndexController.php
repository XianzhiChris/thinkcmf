<?php
namespace app\baiduzhanghao\controller;

use cmf\controller\AdminBaseController;

use app\baiduzhanghao\model\BaiduzhanghaoPostModel;
use app\baiduzhanghao\service\PostService;
...
//            }
            ...
            $portalPostModel = new BaiduzhanghaoPostModel();
    ...
    public function delete()
    {
        ...
        if (isset($param['id'])) {
            ...
            $data         = [
                'object_id'   => $result['id'],
                'create_time' => time(),
                'table_name'  => 'baiduzhanghao_post',
                'name'        => $result['post_zhanghao']
            ];
