<?php
namespace app\tixian\controller;

use cmf\controller\AdminBaseController;

use app\tixian\model\TixianPostModel;
use app\tixian\service\PostService;
...
//            }
            ...
            $portalPostModel = new TixianPostModel();
